...
SELECT CustomerID, Name, Address, City, State, ZipCode, Phone, Email FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        public virtual int GetCustomer(TechSupportDataSet.CustomersDataTable dataTable, int custID) {
...
SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title FROM Incidents WHERE (IncidentID = @IncidentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title\r" +
                "\nFROM            Incidents\r\nWHERE        (CustomerID = @custID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@custID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy(TechSupportDataSet.IncidentsDataTable dataTable, int custID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(custID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
